...
//-----------------------------------------------------------------------------
{
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        {
            colour_ = wxColour( wxColourBase::ChannelType( R >> bitShift ), wxColourBase::ChannelType( G >> bitShift ), wxColourBase::ChannelType( B >> bitShift ) );
        ...
        void SetYUV( int Y, int U, int V, int bitShift = 0 )
        {
            ...
            colour_ = wxColour( wxColourBase::ChannelType( R ), wxColourBase::ChannelType( G ), wxColourBase::ChannelType( B ) );
            Cb_ = U;
            Cr_ = V;
        }
    };
