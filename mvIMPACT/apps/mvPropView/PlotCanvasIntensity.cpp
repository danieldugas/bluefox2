...
//-----------------------------------------------------------------------------
{
    ...
    {
        m_CurrentMaxPlotValue = static_cast<int>( maxVal );
        boFullUpdate = true;
    }
    ...
    {
        m_CurrentMinPlotValue = static_cast<int>( minVal );
        boFullUpdate = true;
    }
...
//-----------------------------------------------------------------------------
{
    ...
    m_CurrentMaxPlotValue = static_cast<int>( numeric_limits<plot_data_type>::min() );
    m_CurrentMinPlotValue = static_cast<int>( numeric_limits<plot_data_type>::max() );
