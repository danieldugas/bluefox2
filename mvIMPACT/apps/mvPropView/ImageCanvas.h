...
public:
    ...
    void                                    SetAOIWizardActive( bool wizardState );
...
private:
    ...
    //-----------------------------------------------------------------------------
    {
        ...
        miPopUpSaveCurrentImage,
        miPopUpCopyCurrentImageToClipboard
    };
    //-----------------------------------------------------------------------------
    ...
    void                                    BlitAOI( wxWindowDC& dc, double scaleFactor, int bmpXOff, int bmpYOff, int bmpW, int bmpH, const AOI* pAOI, bool boDrawOnTop ) const;
    void                                    BlitAOIs( wxWindowDC& dc, double scaleFactor, int bmpXOff, int bmpYOff, int bmpW, int bmpH ) const;
    void                                    BlitAOIs( wxWindowDC& dc, double scaleFactor, int bmpXOff, int bmpYOff, int bmpW, int bmpH, bool boDrawOnTop ) const;
    void                                    BlitSizingPoints( wxWindowDC& dc, double scaleFactor, int bmpXOff, int bmpYOff ) const;
    void                                    BlitInfoStrings( wxWindowDC& dc, double scaleFactor, int bmpScaledViewXOff, int bmpScaledViewVOff, int bmpXOff, int bmpYOff, int bmpW, int bmpH );
    void                                    BlitPerformanceMessages( wxWindowDC& dc, int bmpXOff, int bmpYOff, TImageBufferPixelFormat pixelFormat );
    void                                    ClipAOI( wxRect& rect, bool boForDragging ) const;
    void                                    CopyCurrentImageToClipboard( void );
    ...
    TSaveResult                             GetCurrentImage( wxImage& img, int* pBitsPerPixel = 0 ) const;
    ...
    bool                                    IsCursorOverHorizontalScrollBar( const int mousePositionY ) const;
    bool                                    IsCursorOverVerticalScrollBar( const int mousePositionX ) const;
    ...
    void                                    OnPopUpCopyCurrentImageToClipboard( wxCommandEvent&  )
    {
    ...
    void                                    OnPopUpSaveCurrentImage( wxCommandEvent& e );
    ...
    void                                    SendSnapshotEvent( void ) const;
...
//-----------------------------------------------------------------------------
{
    AOIAccessScope( const AOIAccessScope& );
    AOIAccessScope& operator=( const AOIAccessScope& );
private:
    ImageCanvas& canvas_;
public:
