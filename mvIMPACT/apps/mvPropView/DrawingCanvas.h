...
public:
    ...
    //-----------------------------------------------------------------------------
    static void GetBGR101010Packed_V2Pixel( unsigned int pixel, unsigned short& red, unsigned short& green, unsigned short& blue, const int downShift )
    //-----------------------------------------------------------------------------
    {
        red   = static_cast<unsigned short>(   pixel         & 0x3FF ) >> downShift;
        green = static_cast<unsigned short>( ( pixel >> 10 ) & 0x3FF ) >> downShift;
        blue  = static_cast<unsigned short>( ( pixel >> 20 ) & 0x3FF ) >> downShift;
    }
};
