...
//-----------------------------------------------------------------------------
{
    ...
    mvIMPACT::acquire::PropertyIBoolean*        m_pDeviceRegistersValid;
    ...
    void                                        AbortLiveModeAndInformMainWindow( const wxString& msgForMainWindow );
    void                                        CheckedImageRequestUnlock( const int requestNr ) const;
    bool                                        CheckSequenceRestart( bool boInformUserOnRecordStart ) const;
    void                                        CollectBufferInfo( Component it, Component itImageProcessingResults, std::vector<wxString>& infoStrings, const wxString& path = wxT( "" ) ) const;
    void                                        CollectBufferInfo_ImageProcessingResults( Component it, std::vector<wxString>& infoStrings ) const;
...
public:
    ...
    ~CaptureThread();
    void                                        AttachDeviceRegistersValidProperty( mvIMPACT::acquire::PropertyIBoolean* pDeviceRegistersValid )
    {
        wxCriticalSectionLocker locker( m_critSect );
        m_pDeviceRegistersValid = pDeviceRegistersValid;
    }
    ...
    const mvIMPACT::acquire::SystemSettings&    GetSystemSettings( void ) const
    {
    ...
    void                                        UnpackJpegData( RequestData& requestData ) const;
#if MULTI_SETTING_HACK
