...
//-----------------------------------------------------------------------------
{
    ...
    PropTree( const PropTree& );
    PropTree& operator=( const PropTree& );

    mvIMPACT::acquire::Component    m_rootList;
    ...
    void                                    Delete( void );
    void                                    UpdateGridPropsRecursively( mvIMPACT::acquire::Component iter, wxPGProperty* pListRoot, bool boForceRedraw ) const;
