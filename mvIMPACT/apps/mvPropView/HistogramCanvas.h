...
protected:
    ...
    void                    CalculateSpatialNoiseHistogram_8u_C3Packed( const ImageBuffer* pIB, const int order[3] );
    ...
    void                    CalculatePixelHistogram_8u_RGBPacked( const ImageBuffer* pIB, const int order[3] );
    template<typename _Ty>
